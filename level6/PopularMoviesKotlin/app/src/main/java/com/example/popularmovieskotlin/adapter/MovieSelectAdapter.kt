...
import kotlinx.android.synthetic.main.movie_select_item.view.*

class MovieSelectAdapter(private val movies: List<Movie>, private val onClick: (Movie) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(
            LayoutInflater.from(context).inflate(R.layout.movie_select_item, parent, false)
        )
    }
